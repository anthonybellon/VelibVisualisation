...
with open(get_absolute_path('../data/velib_data_single_time_old.json'), 'r') as file:
...
print(f'Number of stations in velib_data_single_time_old.json: {len(station_codes_single_time)}')
...
# with open('missing_stations.json', 'w') as file:
