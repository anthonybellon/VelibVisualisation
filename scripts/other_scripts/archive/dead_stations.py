...
with open(current_data_path, encoding="utf-8") as file:
...
if isinstance(current_data, dict) and "records" in current_data:
    current_station_codes = {
        station["fields"]["stationcode"] for station in current_data["records"]
    }
...
for historical_file in tqdm(historical_files, desc="Processing historical data files"):
    ...
    with open(historical_file_path, encoding="utf-8") as file:
