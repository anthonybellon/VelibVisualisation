...
merged_data = pd.merge(
    data, current_df, left_on="station_name", right_on="name", how="left", suffixes=("", "_current")
)
...
def convert_row_to_json(row):
    ...
    json_data = {
        ...
        "numdocksavailable": row["capacity"]
        - row["available_mechanical"]
        - row["available_electrical"],
